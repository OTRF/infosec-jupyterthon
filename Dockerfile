...
ENV INSTALL_PIP_PACKAGES azure-cli jupyterlab-git pyvis setuptools_git pandas-bokeh nbcommands awscli attackcti splunk-sdk elasticsearch elasticsearch-dsl geoip2 untangle huntlib requests requests-html graphistry openhunt==1.6.6 jupyter_bokeh
